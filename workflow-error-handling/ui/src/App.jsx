...
// review tasks this caller sees, and the user ID is recorded on decisions. The
// module does not authenticate callers — in a real application a backend or
// gateway sets these from the logged-in user.
const HEADERS = {
